...
func (x *Server_Consumer) GetTopics() []string {
	if x != nil {
		return x.Topics
	}
	return nil
...
func (x *Server_Consumer) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
type Server_Kafka struct {
	...
	Consumers []*Server_Consumer `protobuf:"bytes,2,rep,name=consumers,proto3" json:"consumers,omitempty"`
}
...
func (x *Server_Kafka) GetBrokers() []string {
	if x != nil {
		return x.Brokers
	}
	return nil
...
func (x *Server_Kafka) GetConsumers() []*Server_Consumer {
	if x != nil {
		return x.Consumers
	}
	return nil
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x76, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x52, 0x09, 0x63,
	0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x73, 0x22, 0xdd, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x2d, 0x5a, 0x2b, 0x6b, 0x72, 0x61, 0x74,
	0x6f, 0x73, 0x2d, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2d,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_Consumer)(nil),     // 3: kratos.api.Server.Consumer
	(*Server_Kafka)(nil),        // 4: kratos.api.Server.Kafka
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	4, // 2: kratos.api.Server.kafka:type_name -> kratos.api.Server.Kafka
	5, // 3: kratos.api.Data.database:type_name -> kratos.api.Data.Database
	6, // 4: kratos.api.Data.redis:type_name -> kratos.api.Data.Redis
	3, // 5: kratos.api.Server.Kafka.consumers:type_name -> kratos.api.Server.Consumer
